...
Before this, I was doing data analysis using Jupyter Notebook in Anaconda. Then, I stumbled upon a tutorial 

that used Jupyter in VSCode. I thought it would be easier to write code in VSCode than in Anaconda, so I wrote 

this tutorial to share the process since it only requires three steps.
